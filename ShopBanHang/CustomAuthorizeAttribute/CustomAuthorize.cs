...
namespace ShopBanHang.CustomAuthorizeAttribute
{
    public class CustomAuthorize:AuthorizeAttribute
    {
        ...
        {
            filterContext.Result = new RedirectToRouteResult(new System.Web.Routing.RouteValueDictionary { { "action", "LogIn" }, { "controller", "Account" },{"area",null } });
        }
    }
}